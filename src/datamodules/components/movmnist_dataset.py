...
# --- taken from: https://raw.githubusercontent.com/tychovdo/MovingMNIST/master/MovingMNIST.py
class MovingMNIST(data.Dataset):
    ...
    def __init__(
        self, root, train=True, split=1000, transform=None, target_transform=None, download=False
    ):
